...
@section('container')
    <div class="p-4 rounded-lg dark:border-gray-700 mt-14">
        ...
        <form class="max-w-xl" method="post" action="/dashboard/users/{{ $user->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-5 mt-12">
                ...
                <input type="text" id="username" name="username"
                    ...
                    placeholder="" autofocus value="{{ old('username', $user->username) }}" />
                @error('username')
