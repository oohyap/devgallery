...
@section('container')
    <div class="p-4 rounded-lg dark:border-gray-700 mt-14">
        <div class="mb-5">
            <p class="text-5xl">Upload new project</p>
        </div>
        @if ($errors->any())
        ...
        <form class="max-w-xl" method="post" action="{{ route('projects.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-5 mt-12">
                ...
                <input type="text" id="title" name="title"
                    ...
                    placeholder="Judul Project" autofocus value="{{ old('title') }}" />
                @error('title')
            ...
            <div class="mb-5">
                ...
                <textarea id="body" name="body" rows="4"
                    ...
                    placeholder="Description Your Projects.." required>{{ old('body') }}</textarea>
                @error('body')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
